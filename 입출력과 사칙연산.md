...
[9. 문제번호 11382번](#문제번호-103382번)  
[10. 문제번호 10171번](#문제번호-10171번)   
   + [이스케이프 문자](#이스케이프-문자) 
    
[11. 문제번호 10172번](#문제번호-10172번)  
...
let a = parseInt(input[0]);
let b = input[1];
let b_split = input[1].split("");


let third = a * b_split[2]
let fourth = a * b_split[1]
let fifth = a * b_split[0]
let sixth =  a * parseInt(b);
...
### 공부한 내용
console.log() 함수는 실행 후 자동으로 줄바꿈이 된다.
***
...
### 공부한 내용
#### 이스케이프 문자
자바스크립트에서 이스케이프 문자는 문자열 내에서 특수문자를 문자열 그대로 표시할수 있게 해주는 방법이다.
이스케이프 문자는 역슬래시(\) 를 사용하여 문자열 내에 따옴표,역슬래시,줄바꿈 등과 같은 문자열을 그대로 사용할 수 있게 해줌.
...
참조 : https://blueshare.tistory.com/447
***
